...
public class FilmStreamingVkProSearchAndGoVideoProvider extends SearchAndGoProvider implements IVideoContentProvider {
	...
	public static final String ADDITIONAL_DATA_KEY_QUALITY = "Qualit�:";
	public static final String ADDITIONAL_DATA_KEY_VERSION = "Version:";
	public static final String ADDITIONAL_DATA_KEY_RELEASE_DATE = "Ann�e:";
	...
	public static final String ADDITIONAL_DATA_KEY_DURATION = "Dur�e:";
	 ...
	 * 
	 * @param dataKey
	 *            Something like "Genre:" or "Qualit�:", a key that will used as a line identifier
	 * @param htmlContainer
